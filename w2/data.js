...
async function loadData() {
    try {
        ...
        document.getElementById('result').innerHTML = 
            `<span style="color: #e74c3c;">Error: ${error.message}. Please make sure u.item and u.data files are in the correct location.</span>`;
        throw error;
    }
}
...
function calculateStats() {
    ...
    numMovies = uniqueMovies.size;
    
    console.log(`Dataset stats: ${numUsers} users, ${numMovies} movies, ${ratings.length} ratings`);
}
